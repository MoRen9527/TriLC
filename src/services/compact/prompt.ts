...
1. Chronologically analyze each message and section of the conversation. For each section thoroughly identify:
   ...
   - Pay special attention to specific user feedback you received, especially if the user told you to do something differently.
...
4. Errors and fixes: List all errors that you ran into, and how you fixed them. Pay special attention to specific user feedback you received, especially if the user told you to do something differently.
...
export function getCompactUserSummaryMessage(
  ...
  const baseSummary = `This session is being continued from a previous conversation that ran out of context. The summary below covers the earlier portion of the conversation.
