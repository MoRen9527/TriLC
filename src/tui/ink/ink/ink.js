...
const noop = () => {};
const throttle = (fn,ms)=>{let t;return(...a)=>{if(!t){t=setTimeout(()=>{t=null;fn(...a)},ms)}}};
import _rcC from 'react-reconciler/constants.js';
const { ConcurrentRoot } = _rcC;
import { createRequire } from 'module';
const _require = createRequire(import.meta.url);
const onExit = _require('signal-exit').onExit || _require('signal-exit');
import { flushInteractionTime } from '../_stubs/state.js';
import { getYogaCounters } from '../_stubs/yogaCounters.js';
import { logForDebugging } from '../_stubs/debug.js';
import { logError } from '../_stubs/log.js';
