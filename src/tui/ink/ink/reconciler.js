...
import _cr from 'react-reconciler';
const createReconciler = _cr.default || _cr;
...
// Version compat: 0.29 lacks updateContainerSync/flushSyncWork (0.31+).
if (!reconciler.updateContainerSync) reconciler.updateContainerSync = reconciler.updateContainer;
